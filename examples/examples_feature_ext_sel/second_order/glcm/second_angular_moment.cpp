...
void usarLibreria(vector<vector<int>> imageData,int rows,int cols){
    ...
    img.guardarValorCSV("SECOND ANGULAR MOMENT",m_asm,"/home/user/RESULTADOS/resultadosSecuenciales.csv");
...
void usarLibreriaParalela(vector<vector<int>> imageData,int rows,int cols, int hilos){
    ...
    #pragma omp parallel num_threads(hilos)
    {
        ...
        img2.guardarValorCSV("SECOND ANGULAR MOMENT",m_asm,"/home/user/RESULTADOS/resultadosParalelo.csv");
    }
