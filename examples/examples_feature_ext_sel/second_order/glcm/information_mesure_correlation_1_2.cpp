...
void usarLibreria(vector<vector<int>> imageData,int rows,int cols){
    ...
    img.guardarValorCSV("INFORMATION MESURE CORRELATION 1",m_icorr1,"/home/user/RESULTADOS/resultadosSecuenciales.csv");
    img.guardarValorCSV("INFORMATION MESURE CORRELATION 2",m_icorr2,"/home/user/RESULTADOS/resultadosSecuenciales.csv");
...
void usarLibreriaParalela(vector<vector<int>> imageData,int rows,int cols, int hilos){
    ...
    {
        //8 INFORMATION MESURE CORRELATION 1 Y 2
        m_icorr1 = mesure.f12_icorr(pMatriz, toneCount, hilos);
        m_icorr2 = mesure.f13_icorr(pMatriz, toneCount, hilos);
        img2.guardarValorCSV("INFORMATION MESURE CORRELATION 1",m_icorr1,"/home/user/RESULTADOS/resultadosParalelo.csv");
        img2.guardarValorCSV("INFORMATION MESURE CORRELATION 2",m_icorr2,"/home/user/RESULTADOS/resultadosParalelo.csv");
