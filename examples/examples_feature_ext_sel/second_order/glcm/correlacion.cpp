...
void usarLibreria(vector<vector<int>> imageData,int rows,int cols){
    ...
    img.guardarValorCSV("CORRELACION",m_corr,"/home/user/RESULTADOS/resultadosSecuenciales.csv");
    metrica.calculate();
...
void usarLibreriaParalela(vector<vector<int>> imageData,int rows,int cols, int hilos){
    ...
    #pragma omp parallel num_threads(hilos)
    {
        ...
        img2.guardarValorCSV("SECOND ANGULAR MOMENT",m_corr,"/home/user/RESULTADOS/resultadosParalelo.csv");
    }
