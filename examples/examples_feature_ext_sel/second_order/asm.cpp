...
int main(int argc, char *argv[])
{
    ...
    double calcularteAsm = a.Asm(image);
    cout << "ASM: " << calcularteAsm  << endl;
    double calcularteAsm = a.Asm_OPM(image);
    cout << "ASM using OPM: " << calcularteAsm << endl;
