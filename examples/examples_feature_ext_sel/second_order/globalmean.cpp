...
#include "second_order/globalmean.h"
#include <fstream>
#include <string.h>
#include <cstdlib>
#include <string>
...
int main(int argc, char *argv[])
{
    ...
    double calculartegb = gb.GM(image);
    cout << "Global Mean: " << calculartedM << endl;
    double calculartegb = gb.GM_OPM(image);
    cout << "Global Mean using OMP: " << calculartegb<< endl;
