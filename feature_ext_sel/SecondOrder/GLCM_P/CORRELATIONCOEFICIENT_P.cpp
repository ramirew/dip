#include "CORRELATIONCOEFICIENT_P.h"
#include <iostream>
#include <fstream>
...
void mkbalanced_p (double **a, int n)
{
  int last, j, i;
...
void reduction_p (double **a, int n)
{
  int m, j, i;
  double y, x;
...
//12 CORRELACION
double CORRELATIONCOEFICIENT_P::f3_corr (double **P, int Ng, int hilos) const {
    int i, j;
...
double CORRELATIONCOEFICIENT_P::f14_maxcorr (double **P, int Ng, int hilos) const {
    int i, j, k;
    double *px, *py, **Q;
    double *x, *iy, tmp;
    double f=0.0;
