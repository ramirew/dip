...
Se calcula la varianza de segundo orden sumando el cuadrado de la diferencia entre el índice de sumatoria y el valor medio de la sumatoria, ponderado por la probabilidad de que esa sumatoria se produzca, para cada posible valor de sumatoria. La suma se realiza desde 0 hasta 2 * Ng - 2.
