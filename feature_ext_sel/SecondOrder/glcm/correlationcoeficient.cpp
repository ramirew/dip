...
/*
int hessenberg_p(double** a, int n, double wr[], double wi[]): Calcula la descomposición de Hessenberg de una matriz cuadrada mediante el método QR 
y devuelve las partes real e imaginaria de los valores propios de la matriz.
*/
